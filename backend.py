...
def analyze_image(image_path, mode_key, profile):
    ...
    prompt = (
        ...
        "Если face_visible=true, дай реалистичную и очень точную оценку rating от 1.0 до 10.0 "
        "с одной цифрой после запятой, заполни strengths, advice и summary. "
        "Советы (advice) должны быть конкретными и в каком-то месте грубыми: волосы, кожа, стиль, одежда, поза, освещение. "
        "Если face_visible=false, оставь rating=0.0, strengths и advice пустыми массивами, "
        "а summary пустой строкой. "
        "Оценивай только жестко и по делу."
    )
